...
const messages = defineMessages({
  ...
  infoLegacyMigration: {
    ...
    defaultMessage: 'Share of legacy accounts (imported from the old platform) that have signed in at least once. Scoped to accounts whose registration date falls within the selected period — matches the Legacy Registrations trend.',
  },
  infoEnrollmentTrend: {
