...
const messages = defineMessages({
  ...
  fieldDetail: { id: 'rwaq.admin.orgs.form.detail', defaultMessage: 'About this organization' },
  fieldFeaturedVideo: { id: 'rwaq.admin.orgs.form.featuredVideo', defaultMessage: 'Featured video URL' },
  fieldIsFeatured: { id: 'rwaq.admin.orgs.form.isFeatured', defaultMessage: 'Feature on the public catalog' },
  ...
  detailStatus: { id: 'rwaq.admin.orgs.detail.status', defaultMessage: 'Status' },
  detailFeatured: { id: 'rwaq.admin.orgs.detail.featured', defaultMessage: 'Featured on catalog' },
  detailFeaturedVideo: { id: 'rwaq.admin.orgs.detail.featuredVideo', defaultMessage: 'Featured video' },
  detailAbout: { id: 'rwaq.admin.orgs.detail.about', defaultMessage: 'About' },
  detailNone: { id: 'rwaq.admin.orgs.detail.none', defaultMessage: '—' },
  yes: { id: 'rwaq.admin.orgs.detail.yes', defaultMessage: 'Yes' },
  no: { id: 'rwaq.admin.orgs.detail.no', defaultMessage: 'No' },
